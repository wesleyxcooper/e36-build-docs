...
| **07K Cam + Crank + MAP Sensor Pigtails (3-pin)** | **3-pin VAG active sensor connector OE# 3B0973703G — buy 4 (cam×1 + crank×1 + MAP×1 + spare)** | [Amazon B0DY4CC12Q](https://www.amazon.com/dp/B0DY4CC12Q) — **$11.99 each / ~$48 for 4**. ⚠️ 07K crank uses an **active (Hall-type)** trigger — NOT a passive VR — despite the MaxxECU "VR input" label. Same connector body for cam, crank, and any VAG 3-pin MAP. |
