...
| **Throttle Body — Option B (Cable)** | **VR6 Mk3 OBD2 Throttle Body `021133064A`** | ~$40–80 used eBay. Cable-operated; bolt pattern matches BBG longitudinal manifold. **Stock E36 floor pedal is retained** — no E46 pedal module needed. Stock E36 cable is NOT reusable (VR6 drum uses a different cable end than the M52 drum) — use **Lokar LOK-TC-1000LS148** (~$40–60, cut-to-fit, fits both E36 pedal bracket and VR6 drum). MaxxECU reads TPS passively but does not control throttle position. **Loses MaxxECU e-throttle features** (throttle blip, traction control throttle management, launch control, flat shift). Simpler initial setup — no e-throttle calibration. |
