...
> *Pickup all-in = part + local tax + RT gas (18 MPG @ $4.18/gal) + tolls. Shipped all-in = delivered (part + freight). Queens/NYC tolls ≈ $45 RT (Lincoln Tunnel + NJ Tpk + congestion pricing). All F-series N63/N63TU RWD listed are GEN1 (STUECKL 1087) — confirm on receipt. **⚠️ Path updated (Aug 2026): N63 petrol is now the preferred path — transmission is abundant/cheap ($690–950 local, ~65 mi from 19151) and total build cost is ~$1,000–1,400 lower than N57 despite higher Phase 1 adapter cost. M52 is temporary — Phase 1 adapter cost is not a long-term factor. N57 (F10 535d) has only 1 confirmed US unit at $2,595 shipped. Chatham CNC (mike@chathamcnc.com) is the 07K→N63 adapter source — Phase 3 task, not a blocker for transmission purchase.** Additionally: 2013 F13 650i and 2011–2012 F11 550i → NOT SUPPORTED MaxxECU TCU (Bosch `1034420203`) — prefer 2014+ F10 donors or verify TCU ID before purchase. **Priority boost:** listings with STUECKL sticker + casting number visible in photos = remote pre-screen ✅✅. **Shipped residential liftgate:** PRP-network units (APS, Eagle Auto) deliver to residential with liftgate standard; S2/S4/eBay — confirm liftgate before ordering. ~100–150mi RT feasible with Uhaul.*
>
> | # | ID | Donor | Miles | **All-In** | Method | Contact | Notes |
> | :- | :- | :---- | ----: | ---------: | :----- | :----- | :---- |
> | **1** | P8 | 2014–2016 BMW F10 550i N63TU | unknown | **~$757** | 🚗 Pickup · 57mi RT | [eBay #800288897916](https://www.ebay.com/itm/800288897916) · msg seller · GZ Autoparts, Reading PA | ✅✅ **STUECKL 1087 + ZFS sticker + casting photos in listing** — best remote pre-screen · no call needed · 30-day warranty · confirmed active $689.89 OBO |
