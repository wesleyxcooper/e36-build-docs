...
| Component | Specification | Cost / Action |
| :---- | :---- | :---- |
| **Exhaust Manifold** | **Custom top-mount — fab required** | No off-the-shelf option exists for RHD E36 07K. Must be top-mount to clear steering rack and RHD linkage (see Technical Notes below). Custom fab by local shop or Euromotive Phase 3 scope. **Fabie Boys Motorsports** (Lancaster PA) is a candidate — confirmed RHD E36 turbo experience (see Phase 3 Technical Notes). Ceramic coat mandatory — heat soak will destroy steering rack seals and brake lines. Budget TBD at fab time. |
