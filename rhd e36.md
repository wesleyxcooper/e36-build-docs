...
| :---- | :---- | :---- | :---- |
| [**Double Mint Imports**](https://www.doublemintimports.com/) | Full-service US importer | ✅ Yes | **Preferred option.** Has a UK vehicle-history/estimator tool (plate lookup → manufacture year, fuel, color, cc's, MOT/tax status, 25-year shippability check) that can pre-screen a candidate before committing. Confirm full-service scope (sourcing, collection, shipping, US customs clearance, delivery) directly with them before treating as equivalent to OAI. |
| [**Open Air Imports**](https://www.openairimports.com/) (Baltimore/Richmond, VA) | Full-service US importer | ✅ Yes | Confirmed active. Sources the car, photographs pre-purchase, collects, ships, clears US customs, delivers or holds for pickup. Enthusiast-focused. Ph: 443-300-8745 |
...
| [**AutoTrader UK**](https://www.autotrader.co.uk/) **/ [PistonHeads](https://www.pistonheads.com/)** | UK classifieds | ✅ Self-source | Find the car yourself, then hand off to Double Mint Imports (preferred), OAI, or CFR for collection and shipping. PistonHeads "Wanted" ads surface private sellers actively. |
...
| Component | Specification | Cost / Action |
| :---- | :---- | :---- |
| **Fuel Pump** | **Walbro 255 LPH** | [Walbro GSS342 Install Kit](https://www.realstreetperformance.com/radium-walbro-gss342-255lph-fuel-pump-with-intall-kit-bmw-e36-e46-m3-96-06-s52b32-s54b32.html) \- $149.00 (verified) |
...
| **Brake Booster Delete** | **NES Engineering 6:1 Pedal Ratio Kit** | [NES Engineering Booster Delete](https://nesengineering.com/products/brakboster-delete?variant=57108005880191) \- $216. Removes vacuum booster, changes pedal ratio 3:1 → 6:1 using stock master cylinder. **Install at Phase 1** — firewall grinding is far easier with the engine bay open early. Eliminates vacuum dependency critical for 07K turbo (no manifold vacuum under boost). Benefits: direct pedal feel, removes booster failure mode, no vacuum pump needed in Phase 3\. Tradeoff: higher pedal effort and more travel vs OEM boosted. Optional upgrade: Wilwood/Tilton 19mm master cylinder (\~$150–200) if pedal effort is too high after install. Requires: grinding 2mm off firewall hole \+ pedal box, drilling new hole in brake pedal. Track-only rated. |
...
| Component | Specification | Cost / Action |
| :---- | :---- | :---- |
| **Crankshaft** | **Early Forged 07K** | [eBay Listing 1 (EUR 1,129 OBO)](https://www.ebay.com/itm/385346021056) / [eBay Listing 2 (EUR 959\)](https://www.ebay.com/itm/365953631003) \- \~$1,050 \- $1,250 USD |
...
| **Bearings** | **King XP Tangless** | [King Main Bearing Set](https://www.sbpartsdirect.com/product_p/king_main_bearing_07k.htm) \- $195.99 (verified) |
| **ARP Main Studs** | **ARP-CVB2 (IE-designed kit)** | [Four Season Tuning — ARP-CVB2](https://www.fourseasontuning.com/arp-cvb2-arp-main-stud-kit-for-mk5mk6-25l-5-cylinder-engines) — $299.99. Custom-designed by IE for the VW MK5/MK6 2.5L I5. Eliminates main cap walk and fretting under high-power loads. ARP 8740 alloy, heat-treated to 200K psi, thread-rolled after heat treat. 100% reusable. **Confirmed standard practice on all BBG 07K builds.** Critical: requires align honing after stud installation — coordinate with Euromotive machine shop at build time. | | **360° Thrust Bearing Mod** | **Machine shop operation — \#4 main cap** | No discrete part to order. Request from Euromotive at engine teardown: machine the \#4 main cap to accept a full 360° thrust bearing in place of the stock half-shell. Confirmed in BBG Porsche 944 build video (directly called out) and Jaaatt Engineering 07K forged build. Bearing spec determined by machine shop measurement — typically King or ACL. Budget \~$50–150, absorbed into longblock labor scope. Add explicitly to scope discussion at Euromotive dropoff. |
...
| **Longblock Build Labor (Full Scope)** | **Euromotive Autohaus** | ~~$1,050–1,900 labor (+ head machine work — see separate row). Bring donor motor unopened. Scope: disassembly \+ inspection (~~$150–300) \+ bore/hone/deck (~~$300–600) \+ short block assembly (~~$400–600) \+ head assembly — springs/retainers/shims/lifters install (\~$200–400). You take delivery of a complete sealed longblock. [Euromotive Autohaus](https://www.eurohauspa.com/) — West Chester, PA · (610) 416-5702. |
...
| Component | Specification | Cost / Action |
| :---- | :---- | :---- |
| **Valvetrain** | **Supertech Dual** | [Supertech Valve Spring Kit](https://us.ctsturbo.com/product/supertech-valve-spring-retainer-set-for-audi-vw-2-5l-fits-vw-mk5-mk6-audi-ttrs-rs3/) \- $523.63 (verified) |
...
| **Head Machine Work** | **Euromotive-coordinated** | \~$200–400 (no Inconel valves) or \~$500–1,200 (with Inconel valve seat cut). Euromotive sends head to their machine shop and bills you for it. Separate from assembly labor above. |
...
| Component | Specification | Cost / Action |
| :---- | :---- | :---- |
| **Oil Housing** | **iABED Housing** | [iABED Longitudinal Filter Housing](https://byiabed.com/07K-LONGITUDINAL-Oil-Filter-housing-W-THERMOSTAT_p_156.html) \- $529.00 (verified) |
...
| :---- | :---- | :---- | :---- | :---- |
| **Power Steering** | **Column-Assist EPS (RHD — see options below)** | \~$100–1,300 | See notes | Eliminates hydraulic pump entirely — no belt, no bracket, no lines. The E36 hydraulic rack (or Z3 rack) remains in place and functions as a manual rack; the column-assist EPS compensates upstream. **Z3 rack upgrade recommended:** direct E36 bolt-in, 2.75 turns LTL vs 3.0–3.9 stock, faster turn-in for track use. Cap hydraulic lines at rack. **RHD EPS options:** (1) EPowerSteering.com E36-specific kit KIT-33 ($1,060–1,300 depending on core option) — column core exchange, best documented, **verify RHD column compatibility before ordering** ([epowersteering.com](https://epowersteering.com/purchase/product/bmw-e36/)); (2) Peugeot 206 GTi or Toyota MR2 ZZW30 salvage EPS column (\~$50–100 donor) — RHD native, requires fabricated mount bracket to E36 column, well-documented in UK/AU track community. **Assist adjustment (corrected):** the EPowerSteering KIT-33 uses their "Basic EPS Controller" — a fixed, driver-set assist level via a dash-mounted Adjustment Knob potentiometer. **There is no vehicle-speed input and no MaxxECU/CAN interface on this kit** — assist does not vary with road speed; confirmed against vendor's published BMW e30 and Basic EPS Controller install PDFs (same controller family; no e36-specific PDF is published). Full pin-level wiring documented in [`harnesses/eps-column.wv`](https://github.com/wesleyxcooper/e36-wiring/blob/main/harnesses/eps-column.wv). **Tilt vs Non-Tilt:** this is a core-exchange product — physically confirm whether the car's column has a tilt release lever before ordering (do not assume); non-tilt is preferred and is the mechanically simpler/original E36 column variant, so if the car has a tilt column, the tilt hardware (mounting block, adjustment lever, dowel/locking pins) can be swapped for non-tilt parts from a donor column before shipping the core. Also confirm column tube OD (1.87" or 1.75") before ordering. |
| **Air Conditioning** | **12V Electric AC Compressor (universal)** | \~$400–600 | [Cold Hose Universal Kit](https://coldhose.com/products/universal-12v-electric-compressor-kit) | Not belt-driven — mounts anywhere, powered from chassis 12V. Retains existing E36 condenser, evaporator, and cabin controls. Requires new AC line fabrication to suit compressor port locations. Price TBD — confirm final unit before ordering. |
...
**Reference:** [07K Turbo build… The ULTIMATE 5 cylinder turbo setup\! (YouTube)](https://www.youtube.com/watch?v=V2OxGOoeDmI)
...
| Component | Specification | Cost / Action |
| :---- | :---- | :---- |
| **07K Coolant Hoses** | **Custom E36-to-07K Silicone Kit** | \~$150–300 (Samco/Vibrant universal reducers \+ straight hoses). 07K coolant ports differ from M52 — measure routing at engine-in-car stage before ordering. BBG intake manifold and iABED housing both have coolant connections to route. |
...
| **Phase 2: 07K Build** | $11,000 \- $14,000 | Complete 9,000 RPM 07K buildup \+ full longblock build labor (disassembly through sealed longblock at Euromotive) \+ head machine work \+ adapter plate order \+ LPS oil pump mod (offline). |
...
| **Total Project** | **$45,500 \- $66,000** | **The Ultimate 9,000 RPM E36 Restomod.** |
...
| :---- | :---- | :---- |
| **07K Turbo build… The ULTIMATE 5 cylinder turbo setup\!** | [YouTube](https://www.youtube.com/watch?v=V2OxGOoeDmI) | Comprehensive 07K turbo build reference — valvetrain, oiling, and high-RPM reliability. |
